...
def run_prioritized_planner(aircraft_lst, nodes_dict, edges_dict, heuristics, t, delta_t):
    constraints = []
    for ac in aircraft_lst:
        if ac.spawntime == t:
            ac.status = "taxiing" 
            ac.position = nodes_dict[ac.start]["xy_pos"]
            ac.plan_prioritized(nodes_dict, edges_dict, heuristics, t, delta_t, ac, constraints)
